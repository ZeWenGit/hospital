...
-->
  ...
  HashMap admin = (HashMap)session.getAttribute("admin"); 
	 String sql = "select * from h_p where 1=1 and hdoctor='"+admin.get("id")+"' and status='完成' ";
	 String url = "./jsp/admin/wcbr.jsp?1=1";
...
%>
  <body>
  <form action="./jsp/admin/wcbr.jsp?f=f" method="post">
...
dao.commOper("delete from yy where id="+did);
   ...
   dao.commOper("update yy set status='完成' where id="+wcid);
   }
   ...
   ArrayList<HashMap> nlist=(ArrayList)bean.getCollection();
   	for(HashMap mstu:nlist){
   		HashMap brm = dao.select("select * from h_user where id="+mstu.get("hdoctor")).get(0);
